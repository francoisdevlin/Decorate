...
This is an independant decorator library I've created in order to demonstate the power of decorators.  It is made up of the following parts
...
* decorators.number-protocols - A collection of protcols for converting to a numeric type.
...
Now *every* call to my+ will be logged, and we don't have to think about it.  This is useful, and it gets even better when you consider other decorators like validators or coercing decorators.  Let's take a look at some of the decoratos in decorators.common, to see what other common patterns can be pulled out.
